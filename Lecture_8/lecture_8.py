...
#MLP PCA
MLP_PCA_test = MLPC(max_iter = 500).fit(trnPCA, train_targets) 
...
print(f"The accuracy for the MNIST dataset with MLP with PCA decomposed data is: {acc_PCA_MLP*100:.2f}%")
print(f"The accuracy for the MNIST dataset with MLP with LDA decomposed data is: {acc_LDA_MLP*100:.2f}%")
